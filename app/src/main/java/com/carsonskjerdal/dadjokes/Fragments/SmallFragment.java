 ...
 */
public class SmallFragment extends Fragment implements ScreenShotable, Button.OnClickListener {
    ...
    public static SmallFragment newInstance() {
    ...
    public void takeScreenShot() {
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                SmallFragment.this.bitmap = bitmap;
            }
        };
